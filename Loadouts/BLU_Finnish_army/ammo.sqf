...
// Add clothing
		...
		_unit addBackpack "MNP_B_RUW_CA";

		_unit addMagazines ["CUP_30Rnd_TE1_Red_Tracer_556x45_G36", 20];
		_unit addMagazines ["CUP_100Rnd_556x45_BetaCMag", 5];
		_unit addWeapon "CUP_arifle_G36A";
		_unit addMagazines ["rhsusf_mag_17Rnd_9x19_JHP", 6];
		_unit addWeapon "rhsusf_weap_glock17g4";
		_unit addMagazines ["HandGrenade", 5];
		_unit addMagazines ["SmokeShell", 4];
		_unit addMagazines ["SmokeShellGreen", 4];
